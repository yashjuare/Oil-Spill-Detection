...
json_file = open(r"C:\Users\HP\oil_spills_detection\src\model210425.json", 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights(r"C:\Users\HP\oil_spills_detection\src\model210425.weights.h5")
